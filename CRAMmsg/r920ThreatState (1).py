...
class r920ThreatState(CRAMBaseMessage):
    ...
    def forwardToGroundspace(self, Groundspace: '') -> constants.currentState:
        ...
        if self.CEASEFIRE(): # Stop Interdiction and GOHOME
            print('\nCRAM CEASE FIRE', str(self.dropTrackFlag.data ), datetime.utcnow())
...
#https://stackoverflow.com/questions/18426882/python-time-difference-in-milliseconds-not-working-for-me
    ...
    def CEASEFIRE(self) ->bool:
        return self.dropTrackFlag.data != r920Consts.DropTrackFlag.NOT_DROPPED.value
